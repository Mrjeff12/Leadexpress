...
const translations = {
  en: {
    ...
    'nav.leads': 'My Leads',
    'nav.subcontractors': 'My Sub Contractors',
    'nav.profile': 'Profile',
    'nav.subscription': 'Subscription',
    'nav.telegram': 'Connect WhatsApp',
    ...
    'auth.tagline': 'Smart leads, delivered to your WhatsApp.',
    ...
    'dash.no_leads': 'No leads yet. Make sure your profile is complete and WhatsApp is connected.',
    'dash.plan': 'Plan',
    ...
    'profile.telegram_status': 'WhatsApp Status',
  ...
  he: {
    ...
    'nav.subcontractors': 'קבלני המשנה שלי',
    'nav.profile': 'פרופיל',
    'nav.subscription': 'מנוי',
    'nav.telegram': 'חיבור WhatsApp',
    'nav.settings': 'הגדרות',
    ...
    'auth.tagline': 'לידים חכמים, ישירות לWhatsApp.',
    ...
    'dash.no_leads': 'אין לידים עדיין. ודא שהפרופיל שלך מלא וWhatsApp מחובר.',
    'dash.plan': 'מסלול',
    ...
    'profile.telegram_status': 'סטטוס WhatsApp',
